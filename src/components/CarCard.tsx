...
const CarCard = ({
  ...
  const isLargeVehicle = seats >= 10;

  return (
    <div className="relative overflow-hidden p-6 bg-gradient-to-b from-gray-800 to-gray-900 border border-[#FFD700]/30 rounded-xl shadow-[0_0_15px_rgba(255,215,0,0.15)] text-center transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,215,0,0.35)] hover:border-[#FFD700]/60">
      {/* Price Ribbon */}
      ...
      {/* Description */}
      <p className="text-gray-200 text-sm mb-3 px-2 line-clamp-2">
        {description}
      </p>
      ...
      <div className="flex justify-center gap-4 mb-4 px-2">
        <div className="flex items-center bg-[#FFD700]/10 rounded-lg px-3 py-1.5">
          <svg
            ...
            viewBox="0 0 512 512"
            className="w-4 h-4 mr-2 text-[#FFD700] fill-current flex-shrink-0"
          >
            <path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
          </svg>
          <span className="text-sm font-medium text-gray-200">${hour}/hour</span>
        </div>
        {showAirportPrice && (
      ...
      <div className="flex justify-around items-center mb-6 bg-gray-800/50 rounded-lg py-3 px-2">
        ...
        {isLargeVehicle ? (
          <div className="text-center flex flex-col items-center gap-1">
            ...
            <p className="text-gray-200 text-sm font-medium">Entertainment</p>
          </div>
        ) : (
          <div className="text-center flex flex-col items-center gap-1">
            <div className="bg-[#FFD700]/10 p-2 rounded-full mb-1">
