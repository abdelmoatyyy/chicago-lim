            ...
            <div className="p-8 md:p-12 space-y-2">
              ...
              <div className="text-lg text-gray-700 leading-relaxed space-y-4">
                <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-amber-600 first-letter:mr-3 first-letter:float-left">
                  offers convenient and luxurious transportation between Chicago
                  O'Hare and Midway airports to Indiana, Michigan, Wisconsin,
                  and Iowa. Whether you are traveling for business or pleasure,
                  our experienced drivers will ensure a smooth and comfortable
                  journey to your destination
                </p>

                <p>
                  With our reliable service, you can sit back, relax, and enjoy
                  the ride while we take care of the rest. Our commitment to
                  customer satisfaction and attention to detail sets us apart,
                  making us the preferred choice for travelers looking for a
                  hassle-free and stylish
                </p>

                <p>
                  transportation option in the Midwest region. Book your shuttle
                  or limousine service with us today and experience the
                  difference.
                </p>

                <div className=" border-l-4 border-amber-500 p-4 mt-6">
                  <p className="italic font-bold text-black">
                    From the moment you book until the end of your journey, our
                    team works tirelessly to deliver exceptional service. Let us
                    redefine your expectations of interstate travel.
                  </p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col  gap-12">
              ...
              <div className="bg-gray-50 p-6 rounded-xl shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Benefit from expert planning and real-time adjustments for the
                  fastest, smoothest journeys.
                </p>
              </div>
