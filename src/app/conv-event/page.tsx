...
const airportServiceImages = ["/conv1.jpg", "/conv2.jpg", "/conv3.jpg"];
              ...
              <div className="p-8 md:p-12 space-y-2">
                ...
                <div className="text-lg text-gray-400 leading-relaxed space-y-4">
                  <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-amber-600 first-letter:mr-3 first-letter:float-left">
                    ...
                    Whether you're attending a corporate convention, a grand
                    gala, or a private celebration, we focus on delivering
                    unmatched professionalism and efficiency.
                  </p>

                  <p>
                    Our team understands the importance of punctuality and
                    coordination in large-scale events. That’s why we
                    meticulously plan every detail of your transportation,
                    ensuring a smooth and stress-free experience from start to
                    finish.
                  </p>
                  ...
                  <div className=" border-l-4 border-amber-500 p-4 mt-6">
                    <p className="italic font-bold text-gray-300">
                      From small gatherings to large-scale conventions, we are
                      dedicated to exceeding your expectations with top-notch
                      service and attention to detail. Trust us to make your
                      event transportation seamless and memorable.
                    </p>
                  </div>
                </div>
