          ...
          <div className="grid md:grid-cols-2 gap-12 items-center ">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-100 leading-relaxed">
                ...
                airport transportation service. Our meticulously maintained
                fleet of high-end vehicles ensures a seamless, comfortable
              ...
              <div className="p-8 md:p-12 space-y-2">
                ...
                <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                  <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-amber-600 first-letter:mr-3 first-letter:float-left">
                    ...
                    and secure transportation experience for families and
                    business people alike. We understand the importance of
                    feeling comfortable and at ease while traveling, especially
                    to and from the airport.
                  </p>

                  <p>
                    That is why we only hire professional drivers who are
                    trained to provide the highest level of service and care to
                    our customers. Unlike other transportation services, our
                    drivers are not strangers - they are experienced
                    professionals who have been thoroughly screened and vetted
                  ...
                  <p>
                    ...
                    is to make your journey as smooth and stress-free as
                    possible.
                  </p>

                  <div className=" border-l-4 border-amber-500 p-4 mt-6">
                    <p className="italic font-bold text-gray-100">
                      From the moment you book with us to the moment you arrive
                      at your destination, our team will go above and beyond to
                      ensure your satisfaction. So sit back, relax, and enjoy
                      the ride with our Airport Limousine service.
                    </p>
                  </div>
                </div>
