          ...
          <div className="grid md:grid-cols-2 gap-12 items-center ">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-200 leading-relaxed">
                ...
                & Night Out Transportation service. Whether you're heading to a
                big game, a concert, or a night on the town, our luxurious fleet
              ...
              <div className="pt-6">
                <Link
                  href="/book-now"
                  className="bg-amber-400 text-white px-8 py-3 rounded-full hover:bg-amber-500 transition-colors duration-300 text-lg font-semibold shadow-lg"
                >
          ...
          <div className="container mx-auto px-4  lg:py-12 ">
            <div className="max-w-4xl mx-auto  shadow-xl rounded-2xl overflow-hidden">
              <div className="p-8 md:p-12 space-y-2">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-100 mb-6 border-b-4 border-amber-400 pb-4">
                  Your Night, Our Priority
                </h2>
                <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                  <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-amber-400 first-letter:mr-3 first-letter:float-left">
                    Your special outing deserves more than just
                    transportation—it deserves an experience. Our Sports & Night
                    Out service is tailored to enhance your evening with
                    luxurious comfort, punctuality, and exceptional service.
                  </p>

                  <p>
                    Whether you're cheering for your favorite team, enjoying
                    live music, or exploring the city’s nightlife, we handle the
                    logistics so you can focus on the fun. Our professional
                    chauffeurs ensure a seamless and stress-free ride from start
                    to finish.
                  </p>

                  <div className=" border-l-4 border-amber-400 p-4 mt-6">
                ...
                <div className="pt-6 border-t border-gray-200">
                  <Link
                    href="/book-now"
                    className="inline-block bg-amber-400 text-white px-8 py-3 rounded-full hover:bg-amber-500 transition-colors duration-300 text-lg font-semibold shadow-lg"
                  >
                    Book Your Night Out Service
                  </Link>
                </div>
