            ...
            <div className="p-8 md:p-12 space-y-2">
              ...
              <div className="text-lg text-gray-700 leading-relaxed space-y-4">
                <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-amber-600 first-letter:mr-3 first-letter:float-left">
                  ...
                  Limousine service is here to deliver just that. We understand
                  the importance of every moment and detail, which is why we
                  prioritize impeccable timing, safety, and elegance.
                </p>

                <p>
                  From the moment you step into one of our meticulously
                  maintained vehicles, you’ll experience unparalleled luxury and
                  care. Our professional chauffeurs are not just drivers;
                ...
                <p>
                  ...
                  convenient but also elegant and glamorous. Contact us today to
                  learn more about our personalized wedding packages and let us
                  help you create lasting memories on your special day.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col  gap-12">
              ...
              <div className="bg-gray-50 p-6 rounded-xl shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Enjoy premium comfort and elegance to complement the charm of
                  your wedding day.
                </p>
              </div>
