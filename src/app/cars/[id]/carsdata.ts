const carData: Record<any, any> = {
  ...
  3: {
    ...
    perHourRate: "$200 / Hour (3 Hrs Min)",
    perDayRate: "$2400 / Day",
    airportTransfer: "$300 All Included",
    passengers: "3 Passengers",
    interior: "Leather Interior",
    features: ["Heated Seats", "On Board Wi-Fi", "Phone Charger"],
    services: [
  ...
  6: {
    ...
    perHourRate: "$165 / Hour (2 Hrs Min)",
    perDayRate: "$1920 / Day",
    airportTransfer: "$330 All Included",
  ...
  7: {
    ...
    perDayRate: "$1320 / Day",
    airportTransfer: "$275 All Included",
    passengers: "10 Passengers",
    interior: "Black Leather Interior",
